...
(function() {
  var Promise, executeTask, foreach, gulp, humanizeTime, isPromise, isStream, streamToPromise, tag, watch, _gulp, _task, _tasks;
  ...
  _task.watch = function(glob, cb) {
    var ready;
    ready = Promise.resolve();
    return watch(glob).pipe(foreach(function(stream, file) {
      ready = ready.then(function() {
        return cb(stream, file, file.event);
      });
      return stream;
    }));
  };
